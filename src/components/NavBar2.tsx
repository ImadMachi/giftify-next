...
export default function Navbar2() {
    ...
    return (
        <nav className="bg-white border-gray-100 border-b-2">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 text-lg font-bold">
                <MenuButton isCollapsed={isCollapsed} setIsCollapsed={setIsCollapsed} />
                <div className={`${isCollapsed && "hidden"} w-full md:block md:w-auto  items-center`} id="navbar-dropdown">
                    <ul className="flex justify-around font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 md:mt-0 md:border-0 md:bg-white">
                        <MenuItem href="#">
                            <div className="flex md:flex-col items-center">
                                <span   className="text-xs text-lg font-bold text-center">new</span>
                            </div>
                        </MenuItem>
                        <MenuItem href="#">
                            <div className="flex md:flex-col items-center">
                                <span className="text-xs text-lg font-bold text-center">holiday</span>
                            </div>
                        </MenuItem>
                        <MenuItem href="#">
                            <div className="flex md:flex-col items-center ">
                                <span className="text-xs text-lg font-bold text-center">birthday</span>
                            </div>
                        </MenuItem>		
                        <MenuItem href="#">
                            <div className="flex md:flex-col items-center">
                                <span className="text-xs text-lg font-bold text-center">gifts</span>
                            </div>
                        </MenuItem>		
                        <MenuItem href="#">
                            <div className="flex md:flex-col items-center">
                                <span className="text-xs text-lg font-bold text-center">home & kitchen</span>
                            </div>
                        </MenuItem>		
                        <MenuItem href="#">
                            <div className="flex md:flex-col items-center">
                                <span className="text-xs text-lg font-bold text-center">jewelry</span>
                            </div>
                        </MenuItem>		
                        <MenuItem href="#">
                            <div className="flex md:flex-col items-center">
                                <span className="text-xs text-lg font-bold text-center">women</span>
                            </div>
                        </MenuItem>
                        <MenuItem href="#">
                        <div className="flex md:flex-col items-center">
                            <span className="text-xs text-lg font-bold text-center">men</span>
                        </div>
                    </MenuItem>
                	<MenuItem href="#">
                    <div className="flex md:flex-col items-center">
                        <span className="text-xs text-lg font-bold text-center">kids</span>
                    </div>
                </MenuItem>
                <MenuItem href="#">
                    <div className="flex md:flex-col items-center">
                        <span className="text-xs text-lg font-bold text-center">fun</span>
                    </div>
                </MenuItem>
                <MenuItem href="#">
                    <div className="flex md:flex-col items-center">
                        <span className="text-xs text-lg font-bold text-center">experiences</span>
                    </div>
                </MenuItem>
                <MenuItem href="#">
                    <div className="flex md:flex-col items-center">
                        <span className="text-xs text-lg font-bold text-center">sale</span>
                    </div>
                </MenuItem>
        ...
        return (
            <Link href="/api/auth/login">
                <div className="flex md:flex-col items-center">
                    ...
                    <span className="text-xs text-lg font-bold text-center">sign in</span>
                </div>
            </Link>
        );
    }
    return (
        <li>
            ...
            >
                <div className="flex md:flex-col items-center">
                    <Icons.User className="text-cyan-600 rotate-0 scale-100 transition-all" />
                    <span className="text-xs text-lg font-bold text-center">{"Hi, " + user.name?.split(" ")[0]}</span>
                </div>
                <svg
            ...
            <div
                id="dropdownNavbar"
                className={`z-10 ${isCollapsed && "hidden"
